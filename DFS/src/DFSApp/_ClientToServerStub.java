...
public class _ClientToServerStub extends org.omg.CORBA.portable.ObjectImpl implements DFSApp.ClientToServer
{
  ...
  public int openFileForRead (String fileTitle) throws DFSApp.ClientToServerPackage.FileNotFoundFailure, DFSApp.ClientToServerPackage.FileLockedForWriteFailure
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                else if (_id.equals ("IDL:DFSApp/ClientToServer/FileLockedForWriteFailure:1.0"))
                    throw DFSApp.ClientToServerPackage.FileLockedForWriteFailureHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public int openFileForWrite (String fileTitle) throws DFSApp.ClientToServerPackage.FileNotFoundFailure, DFSApp.ClientToServerPackage.FileLockedForWriteFailure
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return openFileForWrite (fileTitle        );
            } finally {
                _releaseReply ($in);
            }
  } // openFileForWrite
  ...
  public String writeToFile (int fileID, int location, String contents)
  {
            ...
            try {
                ...
                return writeToFile (fileID, location, contents        );
            } finally {
                _releaseReply ($in);
            }
  } // writeToFile
